...
class ConsentSignature(BaseModel):
	...
	user = models.ForeignKey(
		settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="consent_signatures"
	)
...
def consent_signature_image_path(instance: "ConsentSignatureImage", filename: str) -> str:
