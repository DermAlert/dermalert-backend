...
class ClinicalHistorySingletonViewSet(
    ...
    """
    POST /patients/{user_pk}/forms/clinical-history/ -> create
    GET  /patients/{user_pk}/forms/clinical-history/ -> detail (singleton)
    """
    ...
    def _get_object(self):
        ...
        return get_object_or_404(ClinicalHistory, user__id=user_id)
    ...
    def create(self, request, *args, **kwargs):
        ...
        if ClinicalHistory.objects.filter(user=user).exists():
