...
from .factories import ChronicDiseaseFactory, MedicineFactory, AllergyFactory, UserFactory
...
class TestChronicDiseaseAPI:
    ...
    def test_list(self, api_client: APIClient, chronic_disease_factory: ChronicDiseaseFactory):
